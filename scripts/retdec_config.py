...
ARCHIVE_DECOMPILER = INSTALL_BIN_DIR + '/retdec_archive_decompiler.py'
SIG_FROM_LIB = INSTALL_BIN_DIR + '/retdec_signature_from_library_creator.py'
UNPACK = INSTALL_BIN_DIR + '/retdec_unpacker.py'
